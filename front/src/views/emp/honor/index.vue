            ...
            <Form ref="searchForm" :model="searchForm" inline :label-width="0">
                <Form-item ref="searchForm" :model="searchForm" inline :label-width="0" style="display:flex;">
                    <Form-item label="" prop="title">
                        <Input type="text" v-model="searchForm.title" placeholder="请输入荣誉标题" clearable style="width: 200px" />
                    </Form-item>
                    <Form-item label="" prop="studentId">
                      <Input type="text" v-model="searchForm.studentName" placeholder="请输入学生姓名" clearable style="width: 200px" />
                        <!-- <Select v-model="searchForm.studentId" placeholder="请选择" clearable style="width: 200px">
...
export default {
    ...
    methods: {
        ...
        getDataList() {
            this.loading = true;
            getHonorList(this.searchForm).then(res => {
                this.loading = false;
                if (res.success) {
