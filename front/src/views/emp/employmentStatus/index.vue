            ...
            <Form ref="searchForm" :model="searchForm" inline :label-width="0">
                <Form-item ref="searchForm" :model="searchForm" inline :label-width="0" style="display:flex;">
                    <Form-item label="" prop="userName">
                        <Input type="text" v-model="searchForm.userName" placeholder="请输入学生姓名" clearable style="width: 200px" />
                    </Form-item>
                    <Form-item label="" prop="status">
                        <Input type="text" v-model="searchForm.status" placeholder="请输入就业状态" clearable style="width: 200px" />
                    </Form-item>
...
export default {
    ...
    methods: {
        ...
        getDataList() {
            this.loading = true;
            getEmploymentStatusList(this.searchForm).then(res => {
                this.loading = false;
                if (res.success) {
