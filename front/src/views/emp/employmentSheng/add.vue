<template>
  <div>
    <Card>
      ...
      <Form ref="form" :model="form" :label-width="100" :rules="formValidate" label-position="left" >          <FormItem label="学生ID" prop="userId"  >
          ...
          <FormItem label="学生学号" prop="userNumber"  >
            <Input v-model="form.userNumber" clearable style="width:570px"/>
          </FormItem>
...
<script>
import { addEmploymentStatus } from "./api.js";
  ...
  methods: {
    ...
    handleSubmit() {
      this.$refs.form.validate(valid => {
        if (valid) {
          addEmploymentStatus(this.form).then(res => {
